...
fun MyApp(){
    ...
    if (shouldShowOnboarding){
        OnboardingScreen(onContinuaClicked = {shouldShowOnboarding =false})
    }else{
        Greetings()
    }
...
@Composable
fun OnboardingScreen(onContinuaClicked: () -> Unit){
    ...
    Surface{
        Column(modifier = Modifier.fillMaxSize(),
            ...
            Text("Welcome to the Baseics Codelab!")
...
fun OnBoardingPreview(){
    BasicsCodelabTheme {
        OnboardingScreen(onContinuaClicked = {})
    }
}
